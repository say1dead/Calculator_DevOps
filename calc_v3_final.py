            ...
            if m == n == 3:
                ...
                for i in range(m):
                    ...
                    for j in range(n):
                        a.append(int(input()))
                    mat1.append(a)
                r1 = (mat1[0][0] * mat1[1][1] * mat1[2][2] + mat1[0][1] * mat1[1][2] * mat1[2][0] + mat1[1][0] *
                      mat1[2][1] *
                      mat1[0][2])
                r2 = (mat1[0][2] * mat1[1][1] * mat1[2][0] + mat1[0][1] * mat1[1][0] * mat1[2][2] + mat1[0][0] *
                      mat1[1][2] *
                      mat1[2][1])
                print("---------------\n")
            ...
            if m == n == 4:
                ...
                for i in range(m):
                    ...
                    for j in range(n):
                        a.append(int(input()))
                    mat1.append(a)
                r1 = (mat1[1][1] * mat1[2][2] * mat1[3][3] + mat1[1][2] * mat1[2][3] * mat1[3][1] + mat1[2][1] *
                      mat1[3][2] *
                      mat1[1][3]) - (
                                 mat1[1][3] * mat1[2][2] * mat1[3][1] + mat1[1][2] * mat1[2][1] * mat1[3][3] + mat1[1][
                             1] *
                                 mat1[2][3] * mat1[3][2])
                r2 = (mat1[1][0] * mat1[2][2] * mat1[3][3] + mat1[1][2] * mat1[2][3] * mat1[3][0] + mat1[1][3] *
                      mat1[2][0] *
                      mat1[3][2]) - (
                                 mat1[1][3] * mat1[2][2] * mat1[3][0] + mat1[3][2] * mat1[2][3] * mat1[1][0] + mat1[2][
                             0] *
                                 mat1[1][2] * mat1[3][3])
                r3 = (mat1[1][0] * mat1[2][1] * mat1[3][3] + mat1[2][0] * mat1[3][1] * mat1[1][3] + mat1[1][1] *
                      mat1[2][3] *
                      mat1[3][0]) - (
                                 mat1[1][3] * mat1[2][1] * mat1[3][0] + mat1[2][0] * mat1[1][1] * mat1[3][3] + mat1[3][
                             1] *
                                 mat1[2][3] * mat1[1][0])
                r4 = (mat1[1][0] * mat1[2][1] * mat1[3][2] + mat1[2][0] * mat1[3][1] * mat1[1][2] + mat1[1][1] *
                      mat1[2][2] *
                      mat1[3][0]) - (
                                 mat1[1][2] * mat1[2][1] * mat1[3][0] + mat1[3][1] * mat1[2][2] * mat1[1][0] + mat1[2][
                             0] *
                                 mat1[1][1] * mat1[3][2])
